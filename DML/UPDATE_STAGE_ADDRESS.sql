...
-- Procedure Name   :    UPDATE_STAGE_ADDRESS
-- Template         :    wsl_sqlserver_proc_stage
-- Template Version :    8.1.1.0
-- Description      :    Update the Stage Table table STAGE_ADDRESS
-- Generated by     :    WhereScape RED Version 10.4.0.3 (build 250520-210950)
-- Generated for    :    Employee Sultan Shiffa
-- Generated on     :    Monday, August 11, 2025 at 11:15:24
-- Author           :    demo
--==============================================================================
-- Notes / History
--
CREATE PROCEDURE [SCHEMA.UPDATE_STAGE_ADDRESS].UPDATE_STAGE_ADDRESS
  @p_sequence         INTEGER
...
AS
  ...
  BEGIN TRY
    ...
    SET @v_sql = N'TRUNCATE TABLE [TABLEOWNER].[STAGE_ADDRESS]';
    ...
    BEGIN TRANSACTION
      ...
      INSERT INTO [TABLEOWNER].[STAGE_ADDRESS]
     (  ADDRESS_ID
        , ADDRESS_TYPE_CODE
      ) 
      SELECT  LOAD_ADDRESS.ADDRESS_ID AS ADDRESS_ID
    ...
    SET @p_status = 1
    SET @p_return_msg = 'STAGE_ADDRESS updated. '
  ...
  BEGIN CATCH
    ...
    SET @p_status = -2
    SET @p_return_msg = SUBSTRING('UPDATE_STAGE_ADDRESS FAILED with error '
